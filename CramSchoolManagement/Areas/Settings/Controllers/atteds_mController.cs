...
namespace CramSchoolManagement.Areas.Settings.Controllers
{
    public class atteds_mController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "attend_id,year_month,count,create_user,create_date,update_user,update_date")] atteds_m atteds_m)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "attend_id,year_month,count,create_user,create_date,update_user,update_date")] atteds_m atteds_m)
        {
            if (ModelState.IsValid)
            {
