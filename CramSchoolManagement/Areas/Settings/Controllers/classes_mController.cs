...
namespace CramSchoolManagement.Areas.Settings.Controllers
{
    public class classes_mController : Controller
    {
        ...
        {
            return View(db.classes_m.ToList());
        }
        ...
        public ActionResult Create([Bind(Include = "class_id,name,eng_name,create_user,create_date,update_user,update_date")] classes_m classes_m)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "class_id,name,eng_name,create_user,create_date,update_user,update_date")] classes_m classes_m)
        {
            if (ModelState.IsValid)
            {
